...
TRANSLATIONS = {
    ...
    "sr": {
        ...
        "m1_set_label": "M1_set (Pune smjene, brojevi odvojeni zarezima)",
        "m2_set_label": "M2_set (Nepune smjene, brojevi odvojeni zarezima)",
        "m1_set_help": "Lista punih smjena (duže radno vrijeme). Dio M_set. M1_set se automatski popunjava prema dužini pune smjene i raspoloživim intervalima. M2_set se sada automatski popunjava prema trenutnom broju intervala i dužini nepune smjene.",
        "m2_set_help": "Lista nepunih smjena (kraće radno vrijeme). Dio M_set.",
        "m_set_label": "M_set (Smjene, automatski generisane kao M1_set + M2_set)",
        "m_set_help": "M_set se auto-generiše od M1_set i M2_set.",
        "oj_intervals_label": "Oj (Intervali dostupni za odmor tokom smjene j, samo za M1 smjene):",
        ...
        "full_time_shift_length_help": "Dužina pune smjene izražena u broju intervala.",
        "half_time_shift_length_help": "Dužina nepune smjene izražena u broju intervala.",
        ...
        "oj_intervals_help": "Radnici mogu koristiti pauze u ovim intervalima tokom smjene.",
        "ind_within_help": "Aktivnosti čiji zahtjevi za radnicima se moraju ispuniti u okviru zadanog broja intervala.",
        "ind_until_help": "Aktivnosti čiji zahtjevi za radnicima se moraju ispuniti do zadanog intervala dana.",
        "dependent_within_help": "Aktivnosti čiji zahtjevi za radnicima zavise od realizacije drugih aktivnosti.",
        ...
        "max_m1_shifts_help": "Maksimalan broj punih smjena koje se mogu rasporediti. Pune smjene obično traju duže.",
        "max_m2_shifts_help": "Maksimalan broj nepunih smjena koje se mogu rasporediti. Nepune smjene obično traju kraće.",
        "m2_ratio_limit_help": "Maksimalni odnos nepunih smjena (M2) u odnosu na ukupan broj smjena (M1 + M2). Na primjer, 0.3 znači da maksimalno 30% smjena može biti nepuno.",
        "istovar_kontrola_ratio_help": "Odnos radnika za kontrolu u odnosu na radnike koji obavljaju istovar.",
        "non_primary_activities_ratio_help": "Maksimalni odnos sporednih aktivnosti koje radnici pune smjene (M1) mogu obavljati.",
        ...
        "m1_cost_rates": "Koeficijenti troškova za pune smjene (M1):",
        "m2_cost_rates": "Koeficijent troškova za nepune smjene (M2):",
        "m1_cost_help": "Cijena po punoj smjeni za",
        "m2_cost_help": "Cijena po nepunoj smjeni za",
        "working_full_time": "Radi pune smjene (M1).",
        "working_part_time": "Radi nepune smjene (M2).",
    ...
    **Izlazna tabela - Ukupne aktivnosti po intervalu**: Upoređuje traženi i raspoređeni broj radnika za svaku aktivnost i interval.
    """,
        ...
        "total_active_shifts": "Ukupan broj aktivnih smjena",
        ...
        "employees_per_shift": "Radnici po smjeni i profilu (ytj)",
        "shift_allocation_timetable": "Tabela rasporeda smjena",
