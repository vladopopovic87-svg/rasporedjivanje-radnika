...
DEFAULT_M2_SHIFT_START = 51
DEFAULT_M2_SET = list(range(DEFAULT_M2_SHIFT_START, DEFAULT_M2_SHIFT_START + 8))
DEFAULT_M_SET = DEFAULT_M1_SET + DEFAULT_M2_SET
...
# Model constraints
DEFAULT_MAX_WORKERS_PER_INTERVAL = 40
DEFAULT_MAX_M1_SHIFTS = 3
DEFAULT_MAX_M2_SHIFTS = 2
DEFAULT_M2_RATIO_LIMIT = 0.6
DEFAULT_NON_PRIMARY_ACTIVITIES_RATIO = 0.5
DEFAULT_ISTOVAR_KONTROLA_RATIO = 0.5
DEFAULT_BALANCING_MAX_ITERATIONS = 1000
